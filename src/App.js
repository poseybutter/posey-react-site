import React from "react"; // 리액트를 사용하기 위해 리액트 라이브러리를 불러오고 있다. 이렇게 하면 리액트의 기능과 컴포넌트를 사용할 수 있다.
...
const App = () => { // 화살표 함수로 정의된 함수형 컴포넌트. 리액트 애플리케이션의 최상위 컴포넌트로, 라우팅 설정을 포함하고 있다.
    return (
        <BrowserRouter> 
            <Routes>
